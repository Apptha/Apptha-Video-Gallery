...
if (! class_exists ( 'ContusSocialCommentView' )) {
  ...
  class ContusSocialCommentView extends ContusCategoryAdsenseDisplay {
    ...
    public function displaySocialIcons ( $fbAPIKey, $videodescription, $video_thumb, $video_title ) {
      ...
      $tweetshare_image  = getImagesDirURL() .'/tweet.png' ;
      ...
      return '<div class="video-socialshare">
                          <div class="floatleft" style=" margin-right: 3px; margin-top:2px; "> <a href="' . $url_fb . '" class="fbshare" id="fbshare" title="Facebook" target="_blank" ></a> </div>
                          <div class="floatleft ttweet" >
                            <a href="https://twitter.com/share" target="_blank" class="twitter-share-button" text="Twitter" data-count="none" data-url="' . $current_url . '" data-via="' . $blog_title . '" data-text="' . $video_title . '">
                            <img src="'.$tweetshare_image.'" style=" width:100%; height:100%;" style="cursor: pointer;"  >
                            </img></a>
